...
public:
  ...
  //! Pointer to the handler to which nodes are created.
  ...
  //! Removes connections to a slot.
  void removeConnections(QBasicNode *removal);
...
public slots:
  ...
  void removeNode(QBasicNode *removal);
};
